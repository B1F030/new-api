...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		dataRoute.GET("/token_usage", middleware.AdminAuth(), controller.GetTokenUsageDailyData)
		dataRoute.GET("/token_usage/self", middleware.UserAuth(), controller.GetUserTokenUsageDailyData)
